...
WebUI.delay(10)
message = WebUI.getText(findTestObject('Object Repository/Verify/Verify City Name/Suggest_Message'))

//Verify Suggest City Name sudah ada
if (message.contains(input_CityName)) {
	WebUI.click(findTestObject('Object Repository/Search Hotel/Button/Button_Search'))
	KeywordUtil.markPassed('Button search telah diklik')
}

//Verify City Name
getUrl = WebUI.getUrl()
if (getUrl.equals('https://phptravels.net/hotels')) {
	KeywordUtil.markPassed('Url tidak berpindah')
}
