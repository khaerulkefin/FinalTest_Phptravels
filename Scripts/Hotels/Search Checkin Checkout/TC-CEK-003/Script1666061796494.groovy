...
//Verifikasi apakah tanggal checkin bisa diklik setelah hari tersebut terlewati
WebUI.click(findTestObject('Object Repository/Search Hotel/CheckinCheckout/Select_Checkin'))
WebUI.click(findTestObject('Object Repository/Search Hotel/CheckinCheckout/Date/Checkin/td_17'))

checkinDate = WebUI.getAttribute(findTestObject('Object Repository/Search Hotel/CheckinCheckout/Select_Checkin'), 'value')
if (!checkinDate.equals(input_CheckinDate)) {
	KeywordUtil.markPassed('Tanggal checkin jika hari sudah dilewati')
}
