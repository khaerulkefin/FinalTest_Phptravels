...
//Menginputkan Checkin 
WebUI.click(findTestObject('Object Repository/Search Hotel/CheckinCheckout/Select_Checkin'))
WebUI.click(findTestObject('Object Repository/Search Hotel/CheckinCheckout/Date/Checkin/td_30'))

//Verifikasi apakah tanggal checkout bisa diklik sebelum tanggal checkin
WebUI.click(findTestObject('Object Repository/Search Hotel/CheckinCheckout/Date/Checkout/td_29'))

checkoutDate = WebUI.getAttribute(findTestObject('Object Repository/Search Hotel/CheckinCheckout/Select_Checkout'), 'value')
if (!checkoutDate.equals(input_CheckoutDate)) {
	KeywordUtil.markPassed('Tanggal checkout tidak bisa dipilih setelah tanggal checkin')
}
